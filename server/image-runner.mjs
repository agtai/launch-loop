...
function imageContext(context = {}, generated = true) {
  const base = { topic: context.topic ?? '', purpose: context.purpose ?? '', audience: context.audience ?? '' };
